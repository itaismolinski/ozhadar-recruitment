...
export const T = {
  he: {
    ...
    doc_remove: 'הסר קובץ', save_error: 'שגיאה בשמירה. נסה שוב.', save_error_detail: (m) => m ? ('שגיאה בשמירה: ' + m) : 'שגיאה בשמירה. נסה שוב.',
  ...
  en: {
    ...
    doc_remove: 'Remove file', save_error: 'Couldn’t save. Please try again.', save_error_detail: (m) => m ? ('Couldn’t save: ' + m) : 'Couldn’t save. Please try again.',
  ...
  ar: {
    ...
    doc_remove: 'إزالة الملف', save_error: 'خطأ في الحفظ. حاول مرة أخرى.', save_error_detail: (m) => m ? ('خطأ في الحفظ: ' + m) : 'خطأ في الحفظ. حاول مرة أخرى.',
